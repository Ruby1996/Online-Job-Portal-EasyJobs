...
def home(request):
    ...
    if request.method == 'POST': 
        ...
        if srch != "" and loc != "":
            ...
            if com_pro.objects.filter(Q(com_name__icontains=srch)|Q(com_place__icontains=loc)|Q(com_dt__icontains=loc)|Q(com_state__icontains=loc)|Q(com_country__icontains=loc)).exists():
                comp = com_pro.objects.filter(Q(com_name__icontains=srch)|Q(com_place__icontains=loc)|Q(com_dt__icontains=loc)|Q(com_state__icontains=loc)|Q(com_country__icontains=loc))
            ...
            if com_pro.objects.filter(Q(com_name__icontains=srch)).exists():

               comp = com_pro.objects.filter(Q(com_name__icontains=srch))
               return render(request,'can_search.html',{'comp':comp})
            else:
                messages.info(request, 'No Results...')
                return render(request,'can_search.html')   
            ...
            if com_pro.objects.filter(Q(com_place__icontains=loc)|Q(com_dt__icontains=loc)|Q(com_state__icontains=loc)|Q(com_country__icontains=loc)).exists():

                comp = com_pro.objects.filter(Q(com_place__icontains=loc)|Q(com_dt__icontains=loc)|Q(com_state__icontains=loc)|Q(com_country__icontains=loc))
                return render(request,'can_search.html',{'comp':comp})    
     ...
     #   messages.info(request,'Not Eligible for the post')    
       # return redirect('can_jobs')
        ...
        if flag == 3:
            ...
            canprof = can_pro.objects.filter(can_uname= uname)
...
def can_comhome(request,uname,canuname):
    com = com_pro.objects.filter(com_username = uname)
